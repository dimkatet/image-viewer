      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="glass rounded-3xl p-8 animate-pulse">
          <div className="flex items-center space-x-4">
            ...
            <span className="text-xl font-light text-white/80">Загружается магия...</span>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-96 h-96 bg-purple-500/8 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-20 left-1/2 w-64 h-64 bg-cyan-500/12 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4s' }}></div>
      </div>

      {/* Header */}
      <header className={`relative z-10 backdrop-blur-xl border-b border-white/10 transition-all duration-1000 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              ...
              <div className="glass rounded-2xl px-4 py-2 animate-slide-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="hidden md:flex space-x-4">
              ...
              <div className="glass rounded-2xl px-4 py-3 text-center min-w-[80px] glass-hover">
                <div className="text-2xl font-bold text-purple-400">HDR</div>
      ...
      {/* Main Content */}
      <main className={`relative z-10 max-w-6xl mx-auto px-6 py-12 transition-all duration-1000 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
